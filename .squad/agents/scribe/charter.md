...
3. **Deduplicate and consolidate decisions.md:**
   ...
   - Write the updated file back. This handles duplicates and convergent decisions introduced by concurrent agent writes.
...
5. **Git commit:** git add .squad/ && commit. Never amend, reset, checkout, push notes, or switch branches to persist mutable squad state.
